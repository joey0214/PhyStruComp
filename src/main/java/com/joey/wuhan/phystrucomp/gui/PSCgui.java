...
import com.joey.wuhan.phystrucomp.IO.AppendPDB;
import com.joey.wuhan.phystrucomp.IO.LoadSeqs;
import com.joey.wuhan.phystrucomp.IO.LoadPDB;
import java.awt.*;
...
import com.joey.wuhan.phystrucomp.Sequence.SeqAligner;
import com.joey.wuhan.phystrucomp.Structure.CalculationVariation;
import com.joey.wuhan.phystrucomp.Structure.StructureAligner;
...
//    private JSplitPane secseqSiltPane;
    ...
    public void actionPerformed(ActionEvent ace) 
    {
        ...
        { 
            ...
            {
                try {
                    com.joey.wuhan.phystrucomp.IO.AppendPDB appendPDB1 = new  AppendPDB();
                } catch (IllegalSymbolException ex) {
                    Logger.getLogger(PSCgui.class.getName()).log(Level.SEVERE, null, ex);
                }
            } catch (FileNotFoundException ex) {
